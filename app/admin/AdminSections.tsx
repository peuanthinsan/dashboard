...
export function CompaniesSectionClient({
  companies,
  addCompanyAction,
  manageCompanyAction,
}: {
  ...
  return (
    <SectionLayout
      title="Companies"
      description="Create companies and update existing company names."
    >
...
export function OrganizationsSectionClient({
  organizations,
  ...
  return (
    <SectionLayout
      title="Organizations"
      description="Create organizations and update existing organization names."
    >
      <section className="grid gap-6 rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-lg">
        <form
...
export function UsersSectionClient({
  users,
  companies,
  organizations,
  addUserAction,
...
export function DashboardsSectionClient({
  dashboards,
  companies,
  organizations,
  addDashboardAction,
