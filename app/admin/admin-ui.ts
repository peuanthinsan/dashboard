...
export const ADMIN_SECTION = `${cardSection} grid gap-5 p-4 sm:p-6`;

export const ADMIN_CARD = cardBase;

export const ADMIN_CARD_GRADIENT =
  'rounded-2xl border border-zinc-200/70 bg-gradient-to-br from-white to-zinc-50 p-4 shadow-card dark:border-zinc-800/70 dark:from-zinc-900 dark:to-zinc-950';

export const ADMIN_PILL = badgeDefault;

export const ADMIN_FORM_PANEL =
  'rounded-2xl border border-zinc-200/70 bg-gradient-to-br from-white to-zinc-50 p-5 shadow-sm dark:border-zinc-800/70 dark:from-zinc-900 dark:to-zinc-950';

export const ADMIN_ROW_FORM =
  'flex flex-col gap-3 rounded-xl border border-zinc-200/70 bg-white p-4 shadow-sm transition hover:border-zinc-300 hover:shadow-md dark:border-zinc-800/70 dark:bg-zinc-900 sm:flex-row sm:flex-wrap sm:items-end';
