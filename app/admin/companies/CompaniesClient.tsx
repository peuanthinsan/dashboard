  ...
  return (
    <>
      ...
      <AdminModal
        ...
        title="Edit company"
        description="Update company names and remove unused records."
      >
  ...
  return (
    <AdminSection>
      ...
      <div className="grid gap-6">
        <AdminPanel>
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className={`mt-1 text-sm ${ADMIN_TEXT_SUBTLE}`}>
                Review company details and maintain access records.
              </p>
            </div>
          ...
          <div className="mt-4 overflow-hidden rounded-2xl border border-slate-200/70 bg-white/90 shadow-sm dark:border-slate-800/70 dark:bg-slate-950/60">
            ...
            {companies.length === 0 ? (
              <p className={`px-4 py-6 text-sm ${ADMIN_TEXT_SUBTLE}`}>No companies yet.</p>
            ) : null}
          </div>
        </AdminPanel>
      </div>
      ...
      <AdminModal
        ...
        description="Add a company record to control dashboard access."
      >
