  ...
  return (
    <>
      ...
      <AdminModal
        ...
        title="Edit company"
        description="Update company names or remove inactive records."
      >
  ...
  return (
    <AdminSection>
          ...
          <div className="mt-4 overflow-hidden rounded-2xl border border-slate-200/70 bg-white/90 shadow-sm dark:border-slate-800/70 dark:bg-slate-950/60">
            ...
            {companies.length === 0 ? (
              <p className={`px-4 py-6 text-sm ${ADMIN_TEXT_SUBTLE}`}>
                No companies yet. Create one to start assigning dashboards.
              </p>
            ) : null}
          </div>
        </AdminPanel>
      ...
      <AdminModal
        ...
        description="Add a new company record so dashboards can be assigned."
      >
