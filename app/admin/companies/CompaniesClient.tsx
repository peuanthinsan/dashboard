  ...
  return (
    <>
      ...
      <AdminModal
        ...
        title="Edit company"
        description="Update company details and remove access."
      >
        <form action={formAction} className={`${ADMIN_ROW_FORM} gap-4`}>
  ...
  return (
    <AdminSection>
      ...
      <AdminModal
        ...
        description="Add a company to assign dashboards and users."
      >
