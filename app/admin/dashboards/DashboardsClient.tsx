...
function DashboardRow({
  ...
  return (
    <div className="grid gap-4 rounded-xl border border-slate-200 bg-white/90 p-4 dark:border-slate-800 dark:bg-slate-950/60 md:grid-cols-[1.1fr_1.4fr_1fr_1fr_1.2fr_0.8fr_auto]">
  ...
  return (
    <section className="grid gap-6 rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-lg dark:border-slate-800 dark:bg-slate-900/60 sm:p-6">
      ...
      <form
        ...
        className="grid gap-4 rounded-xl border border-slate-200 bg-white/90 p-4 dark:border-slate-800 dark:bg-slate-950/60 md:grid-cols-2"
      >
        <div className="flex flex-col gap-2">
          <label className="text-xs text-slate-500 dark:text-slate-400">Dashboard name</label>
          <input
