...
export default function OrganizationsClient({
  ...
  const companyMap = useMemo(
    () => new Map(companies.map((company) => [company.id, company.name ?? 'No company'])),
    [companies],
  );
                ...
                <tbody>
                  {organizations.map((organization) => (
                    <OrganizationRow
                      ...
                      organization={organization}
                      companies={companies}
                      companyName={organization.companyId ? companyMap.get(organization.companyId) ?? 'No company' : 'No company'}
