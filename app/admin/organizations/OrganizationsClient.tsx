  ...
  return (
    <>
      ...
      <AdminModal
        ...
        title="Edit fleet"
        description="Update fleet names or remove outdated records."
      >
  ...
  return (
    <AdminSection>
          ...
          <div className="mt-4 overflow-hidden rounded-2xl border border-slate-200/70 bg-white/90 shadow-sm dark:border-slate-800/70 dark:bg-slate-950/60">
            ...
            {organizations.length === 0 ? (
              <p className={`px-4 py-6 text-sm ${ADMIN_TEXT_SUBTLE}`}>
                No fleets yet. Create one to group dashboard access.
              </p>
            ) : null}
          </div>
        </AdminPanel>
      ...
      <AdminModal
        ...
        title="Create fleet"
        description="Add a new fleet to scope dashboard access."
      >
