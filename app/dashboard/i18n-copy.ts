...
export const dashboardCopy = {
  en: {
    ...
    drivingV2: {
      ...
      tabDriveHrsPrefix: 'Drive Hr/day',
      tabRestHrsPrefix: 'Rest Hr',
      kpiViolatingDrivers: 'Violating drivers',
      kpiWarnedDrivers: 'Drivers warned',
      warnButton: 'Warn',
      warnSent: 'Warned ✓',
      popoverChannel: 'Channel',
      popoverNote: 'Note (optional)',
      popoverCancel: 'Cancel',
      popoverSend: 'Send',
      popoverSending: 'Sending…',
      popoverErrorNoChannels: 'LINE not configured for this fleet',
      tableHeaderDriver: 'Driver',
      tableHeaderDay: 'Day',
      tableHeaderVehicle: 'Vehicle',
      tableHeaderShifts: 'Shifts',
      tableHeaderFirstLogin: 'First Login',
      tableHeaderLastLogout: 'Last Logout',
      tableHeaderLogin: 'Login',
      tableHeaderLogout: 'Logout',
      tableHeaderLoginLoc: 'Login Loc',
      tableHeaderLogoutLoc: 'Logout Loc',
      tableHeaderTotalDriveHrs: 'Total Drive Hrs',
      tableHeaderRestHrs: 'Rest Hrs',
      tableHeaderDistance: 'Distance',
      tableHeaderStatus: 'Status',
      rowCountLabel: 'rows',
      sheetDriverName: 'Driver Name',
      sheetVehicleNo: 'Vehicle No',
      sheetLoginTime: 'Login Time',
      sheetLogoutTime: 'Logout Time',
      sheetStartTime: 'Start Time',
      sheetEndTime: 'End Time',
      sheetLoginLocation: 'Login Location',
      sheetLogoutLocation: 'Logout Location',
      sheetStartLocation: 'Start Location',
      sheetEndLocation: 'End Location',
      sheetDriveHrs: 'DriveHrs',
      sheetRestTime: 'Rest Time',
      sheetCntDrvHr: 'Cnt Drv Hr',
      sheetDistance: 'Distance',
    },
  },
  th: {
    ...
    drivingV2: {
      tabOverview: 'ภาพรวม',
      tabDriveHrsPrefix: 'ขับรถ/วัน',
      tabRestHrsPrefix: 'พัก',
      kpiViolatingDrivers: 'คนขับที่ฝ่าฝืน',
      kpiWarnedDrivers: 'คนขับที่ได้รับการแจ้ง',
      warnButton: 'แจ้งเตือน',
      warnSent: 'แจ้งแล้ว ✓',
      popoverChannel: 'ช่อง',
      popoverNote: 'หมายเหตุ (ไม่บังคับ)',
      popoverCancel: 'ยกเลิก',
      popoverSend: 'ส่ง',
      popoverSending: 'กำลังส่ง…',
      popoverErrorNoChannels: 'ยังไม่ได้ตั้งค่า LINE สำหรับฟลีตนี้',
      tableHeaderDriver: 'คนขับ',
      tableHeaderDay: 'วันที่',
      tableHeaderVehicle: 'รถ',
      tableHeaderShifts: 'กะ',
      tableHeaderFirstLogin: 'เริ่ม',
      tableHeaderLastLogout: 'จบ',
      tableHeaderLogin: 'เริ่ม',
      tableHeaderLogout: 'จบ',
      tableHeaderLoginLoc: 'สถานที่เริ่ม',
      tableHeaderLogoutLoc: 'สถานที่จบ',
      tableHeaderTotalDriveHrs: 'ขับรวม',
      tableHeaderRestHrs: 'พัก',
      tableHeaderDistance: 'ระยะทาง',
      tableHeaderStatus: 'สถานะ',
      rowCountLabel: 'รายการ',
      sheetDriverName: 'Driver Name',
      sheetVehicleNo: 'Vehicle No',
      sheetLoginTime: 'Login Time',
      sheetLogoutTime: 'Logout Time',
