        ...
        <div className="flex flex-col gap-6">
          <section className={dashboardSectionClass}>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              <PieBreakdown
                title="Fleet volume"
                description="Fleet distribution based on alert activity."
                items={topFleets}
                emptyMessage="No fleet data available."
              />
              <PieBreakdown
                title="Remarks volume"
                description="Most frequent remark tags in the filtered alerts."
                items={topRemarks}
                emptyMessage="No remark data available."
              />
              <PieBreakdown
                title="Vehicle volume"
                description="Top vehicles based on alert activity."
                items={topVehicles}
                emptyMessage="No vehicle data available."
              />
            </div>
