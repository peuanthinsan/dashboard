...
export async function updateUserAssignments(
  ...
  const allowedOrganizationIds = allowedOrganizationRows
    .filter((organization) => organization.companyId && uniqueCompanyIds.includes(organization.companyId))
